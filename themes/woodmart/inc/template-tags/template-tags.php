...
if (!function_exists('woodmart_preloader_template')) {
	...
	?>
		...
		<div class="wd-preloader<?php echo esc_attr($classes); ?>">
			<style>
				<?php if (isset($background_color['idle']) && $background_color['idle']) : ?>.wd-preloader {
					background-color: <?php echo esc_attr($background_color['idle']); ?>
				}

				<?php endif; ?><?php if (!isset($image['id']) || (isset($image['id']) && !$image['id'])) : ?>@keyframes wd-preloader-Rotate {
					0% {
				...
				<?php endif; ?>@keyframes wd-preloader-fadeOut {
					from {
						visibility: visible;
					}
...
if (!function_exists('woodmart_page_top_part')) {
	...
	?>
				...
				<div class="page-title<?php echo esc_attr($title_class); ?>" style="<?php echo esc_attr($style); ?>">
					<div class="container">
						<?php if (get_the_category_list(', ')) : ?>
							<div class="meta-post-categories wd-post-cat wd-style-with-bg"><?php echo get_the_category_list(', '); // phpcs:ignore 
																							?></div>
						<?php endif ?>
				...
				<div class="page-title <?php echo esc_attr($title_class); ?>" style="<?php echo esc_attr($style); ?>">
					<div class="container">
						<?php if (woodmart_woocommerce_installed() && (is_cart() || is_checkout() || $is_cart_builder || $is_checkout_content_builder || $is_checkout_form_builder)) : ?>
							<?php
							echo '<div class="row-viki-styles"><h2 class="viki-section-heading">bag</h2> <div class="wd-button-wrapper text-center">
						<a class="btn btn-style-default btn-style-semi-round btn-size-extra-large btn-color-grey btn-full-width btn-icon-pos-right" href="' . esc_url(get_permalink(wc_get_page_id('shop'))) . '">
							<span class="wd-btn-text">CONTINUE SHOPPING</span></a>
					</div></div>';
							?>
					...
					<div class="container">
						...
						<div class="shop-loop-head">
							...
							<div class="wd-shop-tools">
								<h2 class="category-title"><?php woocommerce_page_title(); ?></h2>
							</div>
		...
		?>
			<div class="mfp-with-anim wd-popup wd-promo-popup<?php echo esc_attr($classes . woodmart_get_old_classes(' woodmart-promo-popup')); ?>">
		...
		?>
			...
			if (!function_exists('woodmart_mobile_menu')) {
				function woodmart_mobile_menu()
				{
					...
					if ($close_btn) {
						echo '<div class="wd-heading"><div class="close-side-widget wd-action-btn wd-style-text wd-cross-icon"><a href="#" rel="nofollow">' . esc_html__('', 'woodmart') . '</a></div></div>';
					}
		...
		<div class="row-viki mobile-row">
			<div class="col-2">
				<div class="wd-header-cart wd-tools-element wd-design-5 wd-tools-custom-icon cart-widget-opener wd-style-icon whb-nk303wf8nr1b32c12yyl">
                <a href="' . home_url('/cart/') . '" title="Shopping cart">
						<span class="wd-tools-icon">
                        <img width="24" height="24" src="' . home_url('/wp-content/uploads/2023/11/shopping-cart.svg') . '" class="wd-custom-icon" alt="" decoding="async"> 
						</span>
			...
			<div class="col-2">
				<div class="wd-header-wishlist wd-tools-element wd-style-icon wd-with-count wd-tools-custom-icon wd-design-2 whb-y1e2asp0foj4qy5njxt5" title="My Wishlist">
					<a href="' . home_url('/wishlist/') .'">
						<span class="wd-tools-icon">
							<img width="24" height="24" src="https://vvbbgguuii839.com/wp-content/uploads/2023/11/heart-1.svg" class="wd-custom-icon" alt="" decoding="async">
						<span class="wd-tools-text">
							Wishlist </span>
					</a>
				</div>
			...
			<div class="col-2">
				<div class="wd-header-my-account wd-tools-element wd-event-hover wd-design-1 wd-account-style-icon wd-tools-custom-icon whb-phrw69e669oceps1b56e">
					<a href="' . home_url('/my-account/') .'" title="My account">
						<span class="wd-tools-icon">
							<img width="24" height="24" src="' . home_url('/wp-content/uploads/2023/11/user-circle.svg') .'" class="wd-custom-icon" alt="" decoding="async"> </span>
						<span class="wd-tools-text">
							Login / Register </span>
					</a>
					<div class="wd-dropdown wd-dropdown-register color-scheme-light">
						<div class="login-dropdown-inner">
							<span class="wd-heading"><span class="title">Sign in</span><a class="create-account-link" href="https://vvbbgguuii839.com/my-account/?action=register">Create an Account</a></span>
							<form method="post" class="login woocommerce-form woocommerce-form-login
								" action="https://vvbbgguuii839.com/my-account/">
								...
								<p class="form-row">
									<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="222bd9431f"><input type="hidden" name="_wp_http_referer" value="/"> <button type="submit" class="button woocommerce-button woocommerce-form-login__submit" name="login" value="Log in">Log in</button>
								</p>
								<p class="login-form-footer">
									<a href="https://vvbbgguuii839.com/my-account/lost-password/" class="woocommerce-LostPassword lost_password">Lost your password?</a>
						...
						if (!empty($mobile_categories_menu)) {
							wp_nav_menu(
								array(
									...
									'menu_class' => 'mobile-categories-menu wd-nav wd-nav-mobile' . $extra_menu_classes . $categories_active . woodmart_get_old_classes(' site-mobile-menu'),
					...
					if (has_nav_menu($location)) {
						wp_nav_menu(
							array(
								...
								'menu_class'     => 'mobile-pages-menu wd-nav wd-nav-mobile' . $extra_menu_classes . $pages_active . woodmart_get_old_classes(' site-mobile-menu'),
								'walker'         => new WOODMART_Mega_Menu_Walker(),
							)
						);
					} else {
			...
			if (!function_exists('woodmart_display_icon')) {
				function woodmart_display_icon($img_id, $img_size, $default_size)
				{
					...
					if (woodmart_is_svg($icon_src)) {
						...
						return '<div class="img-wrapper">' . $icon . '</div>';
					}
				}
			}
