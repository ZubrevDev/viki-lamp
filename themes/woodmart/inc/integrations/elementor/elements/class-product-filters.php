	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'{{WRAPPER}} [class*="wd-grid"]' => '--wd-col: {{SIZE}}',
				),
				'condition'   => array(
					'display_grid' => 'number',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'     => 10,
				'selectors'   => array(
					'{{WRAPPER}} [class*="wd-grid"]' => '--wd-gap: {{VALUE}}px;',
				),
				'render_type' => 'template',
			)
		);
	...
	public function orderby_filter_template( $settings ) {
		$options = apply_filters(
			...
			array(
				...
				'rating'     => esc_html__( ' average rating', 'woocommerce' ),
				'date'       => esc_html__( ' latest', 'woocommerce' ),
				'price'      => esc_html__( ' price: low to high', 'woocommerce' ),
				'price-desc' => esc_html__( ' price: high to low', 'woocommerce' ),
			)
		);
