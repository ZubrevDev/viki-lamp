...
$logo = '<img src="' . $logo_url . '" alt="' . get_bloginfo( 'name' ) . '" 11style="max-width:100%;" />';
...
?>
<div class="site-logo<?php echo esc_attr( $logo_classes ); ?>"style="max-height:fit-content; padding-bottom: 8px;">
