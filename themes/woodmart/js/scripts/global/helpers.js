	...
	woodmartThemeModule.setupMainCarouselArg = function() {
		...
		woodmartThemeModule.setupMainCarouselArg = function() {
			...
			woodmartThemeModule.mainCarouselArg = {
				...
				startPosition  : woodmartThemeModule.$mainCarouselWrapper.hasClass('thumbs-position-centered') ? woodmart_settings.centered_gallery_start : 1,
				...
				navText        : false,
				navClass       : [
					'owl-prev wd-btn-arrow viki-custom-prev',
					'owl-next wd-btn-arrow viki-custom-next'
				]
			};
		}
	}
