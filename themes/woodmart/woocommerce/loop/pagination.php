	...
	<div class="wd-loop-footer products-footer col-lg-8">
		<?php if ( $pagination == 'more-btn' || $pagination == 'infinit' ) : ?>
			<?php if ( get_next_posts_link() ) : ?>
				...
				<a href="<?php echo next_posts( $wp_query->max_num_pages, false ); ?>" rel="nofollow noopener" class="btn wd-load-more wd-products-load-more load-on-<?php echo 'more-btn' === $pagination ? 'click' : 'scroll'; ?>"><span class="load-more-label"><?php esc_html_e( 'See more', 'woodmart' ); ?></span></a>
