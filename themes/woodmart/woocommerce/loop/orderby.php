...
$ordering_classes .= ! empty( $builder_ordering_classes ) ? $builder_ordering_classes : ' viki-form-style ';
?>
<form class="<?php echo esc_attr( $ordering_classes ); ?>" method="get">Sort by:
	<?php if ( ! empty( $list ) ): ?>
		<ul>
