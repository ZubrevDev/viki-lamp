...
<?php if ( $users_can_register ): ?>
	...
	<div class="lrm-signup-section <?php echo $users_can_register && $default_tab == 'register' ? 'is-selected' : ''; ?>"> <!-- sign up form -->
		...
		<?php else: ?>
			...
			<form class="lrm-form js-lrm-form" action="#0" data-action="registration" data-lpignore="true id="registration-form-modal" <?php echo $register_additional_atts; ?>>
                    ...
                    <?php else: ?>
                        <?php if( ! lrm_setting('general_pro/all/hide_username') ): ?>
                            <p class="fieldset fieldset--username">
                                ...
                                <input name="username" class="full-width has-padding has-border" id="signup-username" type="text" placeholder="name:" <?= $fields_required; ?> aria-label="<?= $username_label; ?>" autocomplete="off" data-lpignore="true">
                                <span class="lrm-error-message"></span>
                            </p>
                        <?php endif; ?>

			            <?php if( lrm_setting( 'security/general/use_honeypot' )  ): ?>
                            <p class="fieldset fieldset--login">
                                <label class="image-replace lrm-username lrm-ficon-user" for="signup-login" title="Login"></label>
                                <input name="login" class="full-width has-padding has-border" id="signup-login" type="text" autocomplete="off" data-lpignore="true">
                            </p>
	                    <?php endif; ?>

                        <p class="fieldset fieldset--phone">
                            
                            <label for="billing_phone " class="image-replace lrm-phone lrm-ficon-phone" ></label>
                            <input type="tel" class="full-width has-padding has-border" name="billing_phone" id="" placeholder="phone:" value="" autocomplete="tel">
                            <span class="lrm-error-message"></span>
                        </p>
...
<!--                            </div>-->
                        ...
                        <p class="fieldset fieldset--email">
                            ...
                            <input name="email" class="full-width has-padding has-border" id="signup-email" type="email" placeholder="email adress:" <?= $fields_required; ?> autocomplete="off" aria-label="<?= $email_label; ?>">
                            <span class="lrm-error-message"></span>
                        </p>

                        <p class="fieldset fieldset--password">
                            <label for="billing_password " class="image-replace lrm-password lrm-ficon-password" ></label>
                            <input name="billing_" id="password-registration" class="full-width has-padding has-border"  type="tel" placeholder="password:" data-intl-tel-input-id="0" required>
                            <span class="lrm-error-message"></span>
                        </p>
