...
<div class="lrm-main lrm-font-<?= $icons_class; ?> <?php echo !$is_inline ? 'lrm-user-modal' : 'lrm-inline is-visible'; ?> <?= esc_attr($extra_main_class); ?>" <?php echo !$is_inline ? 'style="visibility: hidden;"' : ''?>>
    ...
    <div class="lrm-user-modal-container">
        <div class="row">
            <div class="col-8 viki-headblock-style">
                <img src="http://viki-lampone.local/wp-content/uploads/2024/02/Viki-logo-small.svg"></img>
                <p class="viki-welcom-text">Welcome! Please enter your details</p>
                </div> 
            </div>
