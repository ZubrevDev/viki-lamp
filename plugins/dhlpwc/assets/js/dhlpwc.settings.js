jQuery(document).ready(function($) {
    ...
    $(document.body).on('click', 'input#woocommerce_dhlpwc_test_connection', function(e) {
    ...
    }).on('dhlpwc:check_track_trace_mail', function(e) {
        if ($('input[name=woocommerce_dhlpwc_enable_track_trace_mail]').is(':checked')) {
            $('select[name=woocommerce_dhlpwc_track_trace_mail_location]').closest('tr').show();
        } else {
            $('select[name=woocommerce_dhlpwc_track_trace_mail_location]').closest('tr').hide();
        }
    }).on('change', 'input#woocommerce_dhlpwc_enable_track_trace_mail', function(e) {
        $(document.body).trigger('dhlpwc:check_track_trace_mail');
    }).on('dhlpwc:check_servicepoint_in_order_mail', function(e) {
        if ($('input[name=woocommerce_dhlpwc_enable_servicepoint_in_order_mail]').is(':checked')) {
            $('input[name=woocommerce_dhlpwc_servicepoint_mail_default_style]').closest('tr').show();
        } else {
            $('input[name=woocommerce_dhlpwc_servicepoint_mail_default_style]').closest('tr').hide();
        }
    }).on('change', 'input#woocommerce_dhlpwc_enable_servicepoint_in_order_mail', function(e) {
        $(document.body).trigger('dhlpwc:check_servicepoint_in_order_mail');
        ...
        // Woocommerce 8.4.0 added the wc-shipping-zone-method-fields div, breaking styling.
        // Removing this div to keep our css compatible with both versions.
        if ($('#dhlpwc_shipping_method_settings .wc-shipping-zone-method-fields').length) {
            $('#dhlpwc_shipping_method_settings .wc-shipping-zone-method-fields').contents().unwrap();
        }
    ...
    }).on('change', 'select[name=woocommerce_dhlpwc_check_default_insurance]' , function(e) {
        $(document.body).trigger('dhlpwc:select_default_insurance_order_value')
    }).on('dhlpwc:select_default_insurance_order_value', function(e) {
        if ($('.dhlpwc-check-default-insurance-setting').val() === '') {
            $('.dhlpwc-min-value-before-insurance-setting').closest('tr').hide();
        } else {
            $('.dhlpwc-min-value-before-insurance-setting').closest('tr').show();
        }

        if ($('.dhlpwc-check-default-insurance-setting').val() === 'custom_value') {
            $('.dhlpwc-custom-insurance-value-setting').closest('tr').show();
        } else {
            $('.dhlpwc-custom-insurance-value-setting').closest('tr').hide();
        }
    }).on('change', 'input[name=woocommerce_dhlpwc_check_default_pers_note]' , function(e) {
        $(document.body).trigger('dhlpwc:checkbox_default_pers_note')
    }).on('dhlpwc:checkbox_default_pers_note', function(e) {
        if ($('input[name=woocommerce_dhlpwc_check_default_pers_note]').is(':checked')) {
            $('input[name=woocommerce_dhlpwc_default_pers_note_input]').closest('tr').show();
        } else {
            $('input[name=woocommerce_dhlpwc_default_pers_note_input]').closest('tr').hide();
        }
        ...
        $.each(dhlpwc_delivery_times_collection, function (i, option_identifier) {
            ...
            $('.dhlpwc-delivery-times-option[data-delivery-times-group="' + option_identifier + '"]').each(function (e) {
                ...
                // Create a label if starting from time select is available
                if ($(this).attr('id').indexOf('_dhlpwc_delivery_time_starting_from_') > -1) {
                    $(this).closest('tr').find('th').first().find('label').clone()
                      .removeAttr('id for class')
                ...
                if ($(this).attr('id').indexOf('_dhlpwc_delivery_time_cut_off_') > -1) {
                    ...
                    if (option_identifier == 'same_day' || option_identifier == 'no_neighbour_same_day') {
                        var dhlpwc_wrap = '<td colspan="3"></td>';
                    } else if (option_identifier == 'next_day' || option_identifier == 'no_neighbour_next_day') {
        ...
        if ($('#dhlpwc-option-group-error-same_day').length === 0) {
            $('#dhlpwc-option-group-mirror-same_day').after('<tr id="dhlpwc-option-group-error-same_day" class="dhlpwc_warning"><td colspan="7">' + dhlpwc_settings_object.option_delivery_time_error + '</td></tr>');
        }
        if ($('#dhlpwc-option-group-error-no_neighbour_same_day').length === 0) {
            $('#dhlpwc-option-group-mirror-no_neighbour_same_day').after('<tr id="dhlpwc-option-group-error-no_neighbour_same_day" class="dhlpwc_warning"><td colspan="7">' + dhlpwc_settings_object.option_delivery_time_error + '</td></tr>');
        }
        if ($('#dhlpwc-option-group-error-next_day').length === 0) {
            $('#dhlpwc-option-group-mirror-next_day').after('<tr id="dhlpwc-option-group-error-next_day" class="dhlpwc_warning"><td colspan="7">' + dhlpwc_settings_object.option_delivery_time_error + '</td></tr>');
        }
        if ($('#dhlpwc-option-group-error-no_neighbour_next_day').length === 0) {
            $('#dhlpwc-option-group-mirror-no_neighbour_next_day').after('<tr id="dhlpwc-option-group-error-no_neighbour_next_day" class="dhlpwc_warning"><td colspan="7">' + dhlpwc_settings_object.option_delivery_time_error + '</td></tr>');
        }

        if ($('#dhlpwc-delivery-times-group-error-same_day').length === 0) {
            $('#dhlpwc-delivery-times-group-mirror-same_day').after('<tr id="dhlpwc-delivery-times-group-error-same_day" class="dhlpwc_warning"><td colspan="4">' + dhlpwc_settings_object.delivery_time_setup_error + '</td></tr>');
        }
        if ($('#dhlpwc-delivery-times-group-error-no_neighbour_same_day').length === 0) {
            $('#dhlpwc-delivery-times-group-mirror-no_neighbour_same_day').after('<tr id="dhlpwc-delivery-times-group-error-no_neighbour_same_day" class="dhlpwc_warning"><td colspan="4">' + dhlpwc_settings_object.delivery_time_setup_error + '</td></tr>');
        }
        if ($('#dhlpwc-delivery-times-group-error-next_day').length === 0) {
            $('#dhlpwc-delivery-times-group-mirror-next_day').after('<tr id="dhlpwc-delivery-times-group-error-next_day" class="dhlpwc_warning"><td colspan="4">' + dhlpwc_settings_object.delivery_time_setup_error + '</td></tr>');
        }
        if ($('#dhlpwc-delivery-times-group-error-no_neighbour_next_day').length === 0) {
            $('#dhlpwc-delivery-times-group-mirror-no_neighbour_next_day').after('<tr id="dhlpwc-delivery-times-group-error-no_neighbour_next_day" class="dhlpwc_warning"><td colspan="4">' + dhlpwc_settings_object.delivery_time_setup_error + '</td></tr>');
        }

        $('#woocommerce_dhlpwc_enable_option_same_day-mirror, #woocommerce_dhlpwc_enable_delivery_time_same_day-mirror').trigger('change');
        $('#woocommerce_dhlpwc_enable_option_same_day-mirror, #woocommerce_dhlpwc_enable_delivery_time_next_day-mirror').trigger('change');
        ...
        $('#woocommerce_dhlpwc_enable_option_no_neighbour_same_day-mirror, #woocommerce_dhlpwc_enable_delivery_time_no_neighbour_next_day-mirror').trigger('change');
        ...
        if ((shipping_option_checked && delivery_times_checked) ||
    ...
    }).on('change', '#woocommerce_dhlpwc_enable_option_next_day-mirror, #woocommerce_dhlpwc_enable_delivery_time_next_day-mirror', function (e) {
        var shipping_option_checked = $('#woocommerce_dhlpwc_enable_option_next_day-mirror').is(':checked');
        var delivery_times_checked  = $('#woocommerce_dhlpwc_enable_delivery_time_next_day-mirror').is(':checked');

        var shipping_option_error = $('#dhlpwc-option-group-error-next_day');
        var delivery_times_error  = $('#dhlpwc-delivery-times-group-error-next_day');
    ...
    }).on('change', '#woocommerce_dhlpwc_enable_option_no_neighbour_next_day-mirror, #woocommerce_dhlpwc_enable_delivery_time_no_neighbour_next_day-mirror', function (e) {
        var shipping_option_checked = $('#woocommerce_dhlpwc_enable_option_no_neighbour_next_day-mirror').is(':checked');
        var delivery_times_checked = $('#woocommerce_dhlpwc_enable_delivery_time_no_neighbour_next_day-mirror').is(':checked');

        var shipping_option_error = $('#dhlpwc-option-group-error-no_neighbour_next_day');
        var delivery_times_error = $('#dhlpwc-delivery-times-group-error-no_neighbour_next_day');
    ...
    }).on('dhlpwc:init_delivery_info', function() {
        $('tr#dhlpwc-option-group-mirror-same_day').find('label:first-child').append(
          '<a href="#TB_inline?&width=500&height=150&inlineId=dhlpwc_same_day_info" class="thickbox">🛈</a>' +
          '<div id="dhlpwc_same_day_info" style="display:none;"><p>' + dhlpwc_settings_object.same_day_info + '</p></div>'
        );

        $('tr#dhlpwc-option-group-mirror-next_day').find('label:first-child').append(
          '<a href="#TB_inline?&width=500&height=150&inlineId=dhlpwc_next_day_info" class="thickbox">🛈</a>' +
          '<div id="dhlpwc_next_day_info" style="display:none;"><p>' + dhlpwc_settings_object.next_day_info + '</p></div>'
        );

        $('tr#dhlpwc-option-group-mirror-no_neighbour_same_day').find('label:first-child').append(
          '<a href="#TB_inline?&width=800&height=150&inlineId=dhlpwc_no_neighbour_same_day_info" class="thickbox">🛈</a>' +
          '<div id="dhlpwc_no_neighbour_same_day_info" style="display:none;"><p>' + dhlpwc_settings_object.no_neighbour_same_day_info + '</p></div>'
        );

        $('tr#dhlpwc-option-group-mirror-no_neighbour_next_day').find('label:first-child').append(
          '<a href="#TB_inline?&width=800&height=150&inlineId=dhlpwc_no_neighbour_next_day_info" class="thickbox">🛈</a>' +
          '<div id="dhlpwc_no_neighbour_next_day_info" style="display:none;"><p>' + dhlpwc_settings_object.no_neighbour_next_day_info + '</p></div>'
        );
    ...
    $(document.body).trigger('dhlpwc:init_delivery_info');
