    ...
    public function get_presets()
    {
        return array(
            ...
            array(
                ...
                'information' => __("This delivery option uses the 'Same-day delivery' product.", 'dhlpwc'),
            ),
            array(
                'frontend_id' => 'home-next-day',
                'setting_id' => 'next_day',
                'title' => __('Door delivery arriving tomorrow', 'dhlpwc'),
                'options' => array(
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_DOOR,
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_SDD,
                ),
            ...
            array(
                ...
                'information' => __("This delivery option uses the 'Same-day delivery' product and the 'No delivery to neighbour' products.", 'dhlpwc'),
            ),
            array(
                'frontend_id' => 'home-no-neighbour-next-day',
                'setting_id' => 'no_neighbour_next_day',
                'title' => __('Door delivery arriving tomorrow, avoid dropping at neighbours', 'dhlpwc'),
                'options' => array(
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_DOOR,
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_NBB,
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_SDD,
            ...
            array(
                ...
                'setting_id' => 'morning',
                'title' => __('Door delivery before 12:00PM', 'dhlpwc'),
                'options' => array(
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_DOOR,
