...
class DHLPWC_Model_Service_Access_Control extends DHLPWC_Model_Core_Singleton_Abstract
{
    ...
    const ACCESS_IS_TEST_MODE = 'is_test_mode';
    ...
    const ACCESS_TRACK_TRACE_MAIL_LOCATION = 'track_trace_mail_location';
    ...
    const ACCESS_SERVICEPOINT_DEFAULT_STYLE = 'servicepoint_mail_default_style';
    ...
    const ACCESS_DEFAULT_PERS_NOTE = 'default_pers_note';
    const ACCESS_DEFAULT_PERS_NOTE_INPUT = 'default_pers_note_input';
    const ACCESS_DEFAULT_INSURANCE = 'default_ins';
    ...
    public function check($access_option, $args = array())
    {
        switch($access_option) {
            case self::ACCESS_API:
                ...
                if (!$logic->check_account() && !$logic->is_test_mode()) {
                    return false;
                }
            ...
            case self::ACCESS_IS_TEST_MODE:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->is_test_mode();
                break;
            ...
            case self::ACCESS_TRACK_TRACE_MAIL_LOCATION:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->track_trace_mail_location();
                break;
            ...
            case self::ACCESS_SERVICEPOINT_DEFAULT_STYLE:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->check_service_point_default_style();
            ...
            case self::ACCESS_DEFAULT_PERS_NOTE:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->check_default_pers_note();
                break;

            case self::ACCESS_DEFAULT_PERS_NOTE_INPUT:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->default_pers_note_input();
                break;

            case self::ACCESS_DEFAULT_INSURANCE:
                $logic = DHLPWC_Model_Logic_Access_Control::instance();
                return $logic->check_default_insurance($args);
                break;
