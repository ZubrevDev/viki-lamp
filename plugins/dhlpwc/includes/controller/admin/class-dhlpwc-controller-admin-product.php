...
class DHLPWC_Controller_Admin_Product
{
    ...
    public function save_custom_fields($post_id)
    {
        ...
        $value = isset($_POST['dhlpwc_enable_method_limit']) && wc_clean($_POST['dhlpwc_enable_method_limit']) === 'yes' ? 'yes' : '';
        ...
        $value = isset($_POST['dhlpwc_additional_shipping_fee']) ? wc_clean($_POST['dhlpwc_additional_shipping_fee']) : '';
        $product->update_meta_data('dhlpwc_additional_shipping_fee', str_replace(',', '.', $value));

        $value = isset($_POST['dhlpwc_send_with_bp']) && wc_clean($_POST['dhlpwc_send_with_bp']) === 'yes' ? 'yes' : '';
        ...
        $value = isset($_POST['dhlpwc_send_with_bp_mix']) && wc_clean($_POST['dhlpwc_send_with_bp_mix']) === 'yes' ? 'yes' : '';
